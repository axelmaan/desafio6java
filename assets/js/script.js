...
const elementoHTML = document.querySelector("#propiedad");
let conjuntoPropiedades = "";

for (let casas of propiedades_venta) {
    conjuntoPropiedades += `
        <div class="propiedad Col-12 col-md-4">
...
elementoHTML.innerHTML = conjuntoPropiedades;
